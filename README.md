...
# How
This library uses **programming** and **algorithms** to find a client ID that can be used to access the Soundcloud API.  ~~If you want, you can pass your own client ID as the first argument of `SoundcloudAPI()`.~~  This does not work.
...
## Now with asyncio track fetching
```python
